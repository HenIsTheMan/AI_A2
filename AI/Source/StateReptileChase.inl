Grid<float>* StateReptileChase::im_Grid = nullptr;
Publisher* StateReptileChase::im_Publisher = Publisher::RetrieveGlobalObjPtr();
...
void StateReptileChase::Update(Entity* const entity, const double dt){
...
void StateReptileChase::Exit(Entity* const entity){
}
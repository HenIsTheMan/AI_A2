Sim* StateChaseHealer::sim = nullptr;
Entity** StateChaseHealer::entityMoving = nullptr;
AStar<Vector3, float>* StateChaseHealer::myAStar = nullptr;
std::vector<Vector3>* StateChaseHealer::myShortestPath = nullptr;
HexGrid<float>::GridType StateChaseHealer::gridType = HexGrid<float>::GridType::Amt;
int StateChaseHealer::gridRows = 0;
int StateChaseHealer::gridCols = 0;
int* StateChaseHealer::selectedRow = nullptr;
int* StateChaseHealer::selectedCol = nullptr;
int* StateChaseHealer::selectedTargetRow = nullptr;
int* StateChaseHealer::selectedTargetCol = nullptr;
int* StateChaseHealer::creditsPlayer = nullptr;
int* StateChaseHealer::creditsAI = nullptr;

void StateChaseHealer::Enter(Entity* const entity){
	myAStar->Reset();
...
void StateChaseHealer::Update(Entity* const entity, const double dt){
		...
		if(myShortestPath->empty()){
			...
			*entityMoving = nullptr;
			...
			if(sim->GetEntityLayer()[targetIndex] == nullptr){
				...
				entity->im_Attribs.im_NextState = entity->im_Attribs.im_StateMachine->AcquireState(StateID::StateHealHealer);
				sim->OnEntityActivated(gridCols, entity);
...
void StateChaseHealer::Exit(Entity* const entity){
}
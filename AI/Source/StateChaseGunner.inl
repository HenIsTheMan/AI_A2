Sim* StateChaseGunner::sim = nullptr;
Entity** StateChaseGunner::entityMoving = nullptr;
AStar<Vector3, float>* StateChaseGunner::myAStar = nullptr;
std::vector<Vector3>* StateChaseGunner::myShortestPath = nullptr;
HexGrid<float>::GridType StateChaseGunner::gridType = HexGrid<float>::GridType::Amt;
int StateChaseGunner::gridRows = 0;
int StateChaseGunner::gridCols = 0;
int* StateChaseGunner::selectedRow = nullptr;
...
void StateChaseGunner::Exit(Entity* const entity){
}
Sim* StatePatrolGunner::sim = nullptr;
Entity** StatePatrolGunner::entityMoving = nullptr;
std::vector<Vector3> StatePatrolGunner::myVec = std::vector<Vector3>();
std::vector<bool> StatePatrolGunner::visited = std::vector<bool>();
HexGrid<float>::GridType StatePatrolGunner::gridType = HexGrid<float>::GridType::Amt;
int StatePatrolGunner::gridRows = 0;
int StatePatrolGunner::gridCols = 0;
int* StatePatrolGunner::selectedRow = nullptr;
int* StatePatrolGunner::selectedCol = nullptr;
int* StatePatrolGunner::selectedTargetRow = nullptr;
int* StatePatrolGunner::selectedTargetCol = nullptr;
int* StatePatrolGunner::creditsPlayer = nullptr;
int* StatePatrolGunner::creditsAI = nullptr;

void StatePatrolGunner::Enter(Entity* const entity){
...
void StatePatrolGunner::Update(Entity* const entity, const double dt){
...
void StatePatrolGunner::Exit(Entity* const entity){
}
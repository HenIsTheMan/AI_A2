namespace Obj{
	...
	KnightCreationAttribs<T, Type>::KnightCreationAttribs(const int gridCols, const Sim* const sim, const bool isFlatTop):
		IEntityCreationAttribs<T, Type>()
	{
		...
		IEntityCreationAttribs<T, Type>::im_Spd = 8.0f;
	}
}